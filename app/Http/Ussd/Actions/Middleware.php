...
use App\Http\Ussd\States\Quizz\QuizzWelcome;
...
class Middleware extends Action
{
    ...
    public function run(): string
    {
        ...
        $numero = request()->get('msisdn');
        ussdlog($numero, 'Navigation/start', $shortcode, 'Nouvelle session de naigation');
