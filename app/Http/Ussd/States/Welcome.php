...
use App\Http\Ussd\States\Affinity\MaleName;
...
class Welcome extends State
{
    protected function beforeRendering(): void
    {
        ...
        //            ->listing($principaux)
        //            ->lineBreak(2);
        //ussdlog(request()->get('msisdn'), 'Menu/Welcome', request()->query('sc'), 'Menu de bienvenue servi avec succès');
        $this->menu->xmlmenu(
            [
            'screen_type'                     => 'Menu',
            'text'                            => 'TELECEL KIOSQUE TAM TAM',
            'list'                            => $principaux,
            'back_link'                       => 0,
            'home_link'                       => 1,
            'session_op'                      => 'continue',
